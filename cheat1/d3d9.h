...
D3DCOLOR colorprim = D3DCOLOR_ARGB(138, 212, 255, 1); //PRIMARY CHEAT COLOR 
...
void menu()
{
	...
	DrawString((char*)AY_OBFUSCATE("External"), 5, 5, 25, 255, 255, 255, pFont); $$$;
	...
	if (drawmenu) {
		...
		pFont->DrawTextA(0, (char*)AY_OBFUSCATE("External"), 21, &FontPos, DT_CENTER, colorsec); $$$;
